              ...
              {({
                ...
                <View style={styles.form}>
                  ...
                  <View style={styles.inputWrapper}>
                    ...
                    >
                      <Select.Item label={i18n.t("general.male")} value="male" icon="male" />
                      <Select.Item label={i18n.t("general.female")} value="female" icon="female" />
                      <Select.Item label={i18n.t("general.other")} value="other" icon="transgender" />
                    </Select>
                    {errors.gender && (
                      <Text
                        style={[
