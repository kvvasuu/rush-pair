<template>
  <div
    class="absolute top-16 flex justify-center w-full h-[calc(100%-8rem)] overflow-y-auto"
  >
    <div
      class="absolute top-12 flex flex-col items-center justify-start max-w-[666px] pb-12 w-full"
    >
      <div
      ...
      <div class="relative mt-8 rounded-lg w-4/5">
        <textarea
          id="description"
          type="text"
      ...
      <button
        class="mt-12 select-none rounded-lg py-3 px-8 text-xl text-neutral-50 dark:text-neutral-300 bg-blue-600 hover:bg-blue-500 dark:bg-blue-800 dark:hover:bg-blue-700 transition-all"
