      ...
      <Transition name="fade" mode="out-in">
        ...
        >
          ...
          >
            ...
            <button
              class="mt-auto rounded-lg overflow-hidden w-4/5 flex items-center opaci justify-center text-center p-3 font-semibold cursor-pointer bg-red-500 hover:bg-red-500/75 transition-all"
              @click="deleteAccount"
