<template>
  <div
    class="fixed left-0 top-0 w-16 xl:w-56 h-full hidden md:flex bg-neutral-100 dark:bg-neutral-800 flex-col items-center justify-start"
  >
    ...
    >
      <RouterLink
        to="/app"
        class="h-10 w-full flex items-center justify-center xl:justify-start xl:px-4 md:h-14 gap-6 text-neutral-400 hover:text-neutral-500 dark:text-neutral-500 dark:hover:text-neutral-300"
      >
      ...
      <RouterLink
        to="/app/settings"
        class="h-10 w-full mb-6 mt-auto flex items-center justify-center xl:justify-start xl:px-4 md:h-14 gap-6 text-neutral-400 hover:text-neutral-500 dark:text-neutral-500 dark:hover:text-neutral-300"
      >
        <div class="w-12 flex justify-center items-center">
          <i
